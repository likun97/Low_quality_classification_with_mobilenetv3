...
testloader = torch.utils.data.DataLoader(
    ...
    batch_size=60, shuffle=False,                                          #######  720 
...
class MobileNetV3(nn.Module):
    def __init__(self, n_class=9, input_size=224, dropout=0.5, mode='large', width_mult=1.0):        
...
def get_params():
    ...
    parser.add_argument('--resume' , default='/search/odin/likun/zyresnet/model/model_large_2_no.pth', type=str, metavar='PATH',
        ...
        for epoch in range(1, nb_epoch+1):
            ...
            if test_acc >max_val_acc:
                ...
                save_checkpoint({
                    ...
                    'best_prec1': max_val_acc,
                }, filename=os.path.join('/search/odin/likun/zyresnet/model', 'model_large_3.pth'))
