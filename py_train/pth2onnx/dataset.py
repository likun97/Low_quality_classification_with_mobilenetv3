...
class TheDataset(Data.Dataset):
    def __init__(self, data_root):
        ...
        total_pairs = []
        lines = open('/search/gpu4/plant_data/train_data2/Mutual-Channel-Loss-master/train.txt').read().split('\n')
        for line in lines:
            line = line.strip()
            # print(line)
...
class TheDatasettest(Data.Dataset):
    def __init__(self, data_root):
        ...
        total_pairs = []
        lines = open('/search/gpu4/plant_data/train_data2/Mutual-Channel-Loss-master/test.txt').read().split('\n')
        for line in lines:
            line = line.strip()
            if line:
                tfs, s_idx = line.split('---->')   
...
if __name__ == '__main__':
    data = TheDataset(data_root='/search/gpu4/plant_data/train_data/train')
