...
def test(epoch,net,testloader):
    ...
    with open(os.path.join('/search/odin/xxx/xxxx/test_large_v3_16_width1.csv'), 'w') as out_file:
...
def get_params():
    ...
    parser.add_argument('--resume' , default='/search/odin/xxx/xxx/model/model_large_3.pth', type=str, metavar='PATH', help='path to latest checkpoint (default: none)')
